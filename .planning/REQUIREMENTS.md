...
- [x] **SETUP-04**: User can run `/setup` in a project folder to create a project-scoped persona that overrides global
- [x] **SETUP-05**: User can run `/reset-persona` to wipe persona and re-run setup from scratch

### Packaging

- [x] **PKG-01**: Install script (bash) clones repo and copies files to `~/.claude/` with conflict detection
